  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-gray-50 text-gray-800 p-6">
      ...
      <div className="flex gap-4">
        <Link to="/login" className="px-6 py-2 bg-blue-600 hover:bg-blue-700 text-white font-medium rounded-md shadow-sm">
          Login
        </Link>
        <Link to="/register" className="px-6 py-2 bg-white hover:bg-gray-100 text-blue-600 border border-blue-600 font-medium rounded-md">
          Register
        </Link>
      </div>
    </div>
